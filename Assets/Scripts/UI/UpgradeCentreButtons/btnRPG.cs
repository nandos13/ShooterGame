...
public class btnRPG : upgradeBtnBase {
	...
	public override void Execute ()
	{
		...
		bool purchased = GameStatistics.unlockAttachment(GUN_ATTACHMENTS.RPG, cost);
